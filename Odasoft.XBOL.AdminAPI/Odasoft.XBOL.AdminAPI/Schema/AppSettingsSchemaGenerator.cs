...
public static class AppSettingsSchemaGenerator
{
    ...
    public sealed class AppSettingsSchema
    {
        ...
        [Description("Request localization and culture settings")]
        public LocalizationOptions? Localization { get; set; }

        [Description("ASP.NET Identity password and user policy")]
        public IdentitySettingsOptions? Identity { get; set; }
