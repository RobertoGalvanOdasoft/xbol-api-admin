...
namespace Odasoft.XBOL.Business.Handlers
{
    ...
    {
        public async IAsyncEnumerable<object> HandleAsync(CreateSeasonOrderCommand message)
        {
            var orderId = await orderService.CreateSeasonOrderAsync(message.Request);
